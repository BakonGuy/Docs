...
Engine audio stops ticking its RPM and throttle updates while the vehicle is passive, which is handled automatically. See [Tick and Performance](https://overtorque-creations.com/Dev/Docs/#AVS/Advanced/Tick_And_Performance.md).
