...
<!-- side-by-side:57 -->
Create a new vehicle, and set it up like a trailer. Use the [Creating Vehicles](https://overtorque-creations.com/Dev/Docs/#AVS/Tutorials/Quick_Start.md) page if needed. There is a basic trailer mesh and wheel included in the plugin if you need one.
<!-- split -->
