---
title: "AVS Changelogs"
source: https://avs.overtorque-creations.com/changelog
---
...
**-Fix: ChangeStaticMesh on Vehicle _Wheel causing physics errors after toggling physics off/on (Fixed contact modification not updating)**
...
**-Change: Moved some wheel specific code out of AVS_Vehicle and into Vehicle _Wheel**
...
**-Update VehicleSetup _HUD similar to the UE5 version (Add VehicleMass, PhysicsState, UnrealVersion)**
...
**-New: Vehicle _Wheel can now change location/rotation at runtime easily using the SetWheelPosition function**
...
**-Fix: Vehicle _Wheel ChangeStaticMesh function failing when called after construction but before onBeginPlay (such as in onRep functions)**
...
**-Fix: Compile error due to private function in Vehicle _Hitch**
...
**-Fix: VehicleSetup _HUD breaking vehicles onBeginPlay (due to a change in UE4.23)**
