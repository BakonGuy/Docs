...
source: https://avs.overtorque-creations.com/general/important-information
---
...
Unreal Engine does** not** support true cylinder collisions in Chaos.Faking a cylinder using convex collision may_ look_ correct, but it will not behave correctly—these approximated shapes are not perfectly round, and they will cause the wheels to bounce or behave erratically when driving fast.
...
![Image](../assets/images/general-important-information-01.gif)
...
![Image](../assets/images/general-important-information-02.png)

## **Skeletal Mesh Collisions Are Disabled by Default**

When you attach a **Skeletal Mesh** to theVehicleMeshcomponent,**AVS will automatically disable its collisions** during construction. This is intentional.
...
![Image](../assets/images/general-important-information-03.png)
...
[Embedded media](https://drive.google.com/file/d/1qQbSTNSwgUVjdT_krVEZ9wILCqH5RnGQ/preview)

![Image](../assets/images/general-important-information-04.png)
