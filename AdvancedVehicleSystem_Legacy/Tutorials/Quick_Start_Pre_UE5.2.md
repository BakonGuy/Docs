...
Consider making the recommended changes from the [Project Settings page](https://overtorque-creations.com/Dev/Docs/#AVS_Legacy/General/Project_Settings.md), they will dramatically increase physics stability, and top speed.
