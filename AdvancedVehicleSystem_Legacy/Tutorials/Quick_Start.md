...
**[If you are using a version of Unreal older than 5.2, click here for the legacy documentation](https://overtorque-creations.com/Dev/Docs/#AVS_Legacy/Tutorials/Quick_Start_Pre_UE5.2.md)**

## Step 0: Optional - Configure Project Settings

Consider making the recommended changes from the [Project Settings page](https://overtorque-creations.com/Dev/Docs/#AVS_Legacy/General/Project_Settings.md), they will dramatically increase physics stability, and top speed in the physics wheel mode.
